...
const App = () => {
  ...
  return (
    ...
    >
      ...
      {currentView === 'accountMapping' && (['ds.jang@composecoffee.co.kr', 'kth@composecoffee.co.kr', 'choihy@composecoffee.co.kr', 'lee_mh@composecoffee.co.kr', 'chois1314@composecoffee.co.kr'].includes(user?.email?.toLowerCase()) ? (
        <AccountMappingPage 
          withdrawals={withdrawals}
          selectedDate={selectedDate}
      ...
      {currentView === 'cashFlow' && (['ds.jang@composecoffee.co.kr', 'kth@composecoffee.co.kr', 'choihy@composecoffee.co.kr', 'lee_mh@composecoffee.co.kr', 'chois1314@composecoffee.co.kr'].includes(user?.email?.toLowerCase()) ? (
        <CashFlowPage 
      ...
      {currentView === 'loans' && (['ds.jang@composecoffee.co.kr', 'kth@composecoffee.co.kr', 'choihy@composecoffee.co.kr', 'lee_mh@composecoffee.co.kr', 'chois1314@composecoffee.co.kr'].includes(user?.email?.toLowerCase()) ? (
        <LoanManagementPage 
          loans={loans}
      ...
      {currentView === 'cashEvent' && (['ds.jang@composecoffee.co.kr', 'kth@composecoffee.co.kr', 'choihy@composecoffee.co.kr', 'lee_mh@composecoffee.co.kr', 'chois1314@composecoffee.co.kr'].includes(user?.email?.toLowerCase()) ? (
        <CashEventPage 
          cashFlowSchedules={cashFlowSchedules}
          onUpdateSchedule={updateCashFlowSchedule}
          onDeleteSchedule={deleteCashFlowSchedule}
      ...
      {currentView === 'cashPL' && (['ds.jang@composecoffee.co.kr', 'kth@composecoffee.co.kr', 'choihy@composecoffee.co.kr', 'lee_mh@composecoffee.co.kr', 'chois1314@composecoffee.co.kr'].includes(user?.email?.toLowerCase()) ? (
        <CashPLPage
          withdrawals={withdrawals}
          dailyStatuses={dailyStatuses}
          recordDate={selectedDate}
