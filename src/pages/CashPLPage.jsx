...
const COMPOSE_PL_STRUCTURE = {
  sections: [
    ...
    },
    {
      ...
      label: 'IV. 판매비와 관리비',
      type: 'expense',
      subjects: ['임원급여', '직원급여', '상여금', '퇴직급여', '복리후생비', '여비교통비', '접대비', '통신비', '수도광열비', '전력비', '세금과공과금', '감가상각비', '지급임차료', '임차보증금', '보험료', '차량유지비', '운반비', '교육훈련비', '도서인쇄비', '사무용품비', '소모품비', '지급수수료', '광고선전비', '판매촉진비', '대손상각비', '건물관리비', '무형고정자산상각', '리스료', '자동이체', '환불', '법인카드'],
    },
    {
      id: 'operatingProfit',
      label: 'V. 영업이익',
...
const SMART_PL_STRUCTURE = {
  sections: [
    ...
    },
    {
      ...
      label: 'IV. 판매비와 관리비',
      type: 'expense',
      subjects: ['복리후생비', '지급수수료', '자동이체', '환불', '법인카드'],
    },
    {
      id: 'operatingProfit',
      label: 'V. 영업이익',
